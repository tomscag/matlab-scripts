...
%Methodological note: In directed graphs (vertici direzionati), 
%3 nodes generate up to 8 
...
%%% mi da il vettore di coeff_clustering locale: per ogni vertice i è
%%% definito come il rapporto tra il numero di triangoli con un vertice in
%%% i e il numero di triple centrate in i (cioè i è al centro di 3 vertici
%%% connessi)
